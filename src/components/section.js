...
class Features extends React.Component {
  ...
  render() {
    ...
    if (width > 993) {
      colSizes = ["quarter", "half", "quarter"];
    } else if (width < 769) {
      colSizes = ["", "", ""];
    } else {
      colSizes = ["third", "third", "third"];
    }
        ...
        <div className="container">
          <div className="section_header">
            ...
            <div className="header_text sm dark">
              <p>
                Transmat is a companion app for Destiny 2. With it, you can
                transfer items and get detailed information about your
                characters.
              </p>
            </div>
          </div>
          ...
          <div className="row">
            <div className={"column " + colSizes[0]}>
              <div className="about_slot margin-lg">
                ...
                <div className="header_text">
                  <p>
                    Equip items and transfer them between your characters and
                    vault
                  </p>
                </div>
              </div>
              <div className="about_slot margin-lg">
                ...
                <div className="header_text">
                  <p>
                    View the stats and perk descriptions for your weapons and
                    armor
                  </p>
                </div>
              </div>
            ...
            <div className={"column " + colSizes[2]}>
              <div className="about_slot margin-lg">
                ...
                <div className="header_text">
                  <p>
                    Track milestones, raid completions, and faction reputations
                    for each character
                  </p>
                </div>
              </div>
              <div className="about_slot margin-lg">
                ...
                <div className="header_text">
                  <p>
                    Check your engrams, postmaster, and the contents of your
                    vault
                  </p>
                </div>
              </div>
...
class About extends React.Component {
  ...
  render() {
    ...
    if (activeItem === "acc0") {
      imgPath = "images/type_screen.png";
    } else if (activeItem === "acc1") {
      imgPath = "images/subtype_screen.png";
    } else if (activeItem === "acc2") {
      imgPath = "images/actions_screen.png";
    }
            ...
            <div className="left_col">
              <div className="cell_view">
                <div className="section_header align-left white_color more_text">
                  <h2 className="h2 caption_style_1 left_separator">
                    Why Transmat?
                  </h2>
                  <div className="header_text sm">
                    <p>
                      Transmat makes it simple to find any item on your account,
                      right from your character's inventory:
                    </p>
                  </div>
            ...
            <div className="left_col">
              <div className="cell_view">
                <div className="section_header align-left white_color more_text">
                  ...
                  <div className="header_text sm">
                    <p>
                      Don't have an account or just want to try it out before
                      logging in?
                    </p>
                  </div>
          ...
          <div className="row">
            <div className="column">
              <div className="section_header">
                ...
                <div className="header_text sm dark"></div>
              </div>
              <div className="contact_item divider">
                <div className="text">
                  ...
                  <div className="links">
                    <p>Portfolio</p>
                    <a href="https://jtsdev.github.io">jtsdev.github.io</a>
                  </div>
                </div>
              </div>
              <div className="contact_item">
                <div className="text">
                  ...
                  <div className="links">
                    <p>Email</p>
                    <a href="https://jtsdev.github.io">jtsjordan@hotmail.com</a>
                  </div>
                </div>
              </div>
            </div>
...
const accordionArray = [
  {
    title: "Type",
    text:
      "Clicking a slot will reveal the items the character currently holds of that type, as well as a selection of subtype buttons.  For weapon slots, the subtypes are different weapon classes.  For armor slots, the subtypes are the three character classes."
  },
  {
    title: "Subtype",
    text:
      "Clicking a subtype button will show every item of that subtype that is currently stored ( on another character or in the vault ).  In this way, any item on the account can be found in two quick clicks."
  },
  {
    title: "Actions",
    text:
      "Clicking an item will bring up a summary and its different options for transfer.  The summary card can also be clicked to expand a full overview of the item."
  }
];
